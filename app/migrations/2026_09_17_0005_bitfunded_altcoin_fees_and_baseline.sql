...
INSERT INTO _bf_fee_guard_pre (ok) VALUES (
    ...
    -- gross pnl must still be exactly what both this file and 2026_09_17_0002 were
    -- written against -- if it isn't, something changed challenge 6's trades between
    -- then and now and this file should not proceed blind.
    AND ROUND((SELECT SUM(pnl) FROM trades WHERE challenge_id = 6), 2) = -120.07
);
...
INSERT INTO _bf_fee_guard_post (ok) VALUES (
    ...
    AND ROUND((SELECT SUM(net_pnl) FROM trades WHERE challenge_id = 6), 4) = -258.1859
